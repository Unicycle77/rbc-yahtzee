...
class FullHouse extends Rule {
  evalRoll = dice => {
    ...
    // full house must be exactly 3 of one die and exactly 2 of a different die
...
class LargeStraight extends Rule {
  evalRoll = dice => {
    ...
    // large straight must be 5 different dice in sequence (only one can be a 1 or a 6)
...
const yahtzee = new Yahtzee({ score: 50, description: "50 points for yahtzee (5 are the same)" });
